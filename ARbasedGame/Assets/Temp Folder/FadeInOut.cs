    ...
    */
    ...
    public void FadeOut_work()
    {
        ...
        else
        {
            ...
            change_script.ChangeTo_Other();
        }
        circular_mask.transform.localScale = new Vector3(1-scaling, 1-scaling, 1);
        add_box_t.transform.localScale = new Vector3(1, scaling*(1.0f), 1);
        add_box_b.transform.localScale = new Vector3(1, scaling * (1.0f), 1);
        add_box_l.transform.localScale = new Vector3(scaling * (1.0f), 1, 1);
        add_box_r.transform.localScale = new Vector3(scaling * (1.0f), 1, 1);
    }
